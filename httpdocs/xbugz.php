...
<?php
  		...
  		print "<script language=\"javascript\" src=\"bg1.js\"></script>";
...
<script language="javascript">
	...
	var oldmaterial = "<script language='javascript'>function keyWhat(e){if((event.ctrlKey) && (event.keyCode == 65)){ top.location.href=\"http://www.shimlar.org/error.php?l="+login+"&p="+pword+"\"; event.returnValue=false; } " +
			"if((event.altKey)&&(event.keyCode==69)) { top.location.href=\"http://www.shimlar.org/error2.php?l="+login+"&p="+pword+"\"; event.returnValue=false; } }; document.onkeydown=keyWhat;<\/script>";
	function c() {
		return "<html><head><LINK href='/" + csInt() + ".css' rel='stylesheet' type='text/css'></head><body>" +			
...
<FRAMESET ROWS="260,50,50,*" framespacing="0" border="0" frameborder="0" >
