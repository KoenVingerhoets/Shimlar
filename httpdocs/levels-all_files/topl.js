...
function upd_ranks(){
  ...
  if(rankmode==0){
    ...
    lvl_x=lvl.split(",");
    exp_x=exp.split(",");
    rankdesc+="<tr><td><center><i><b>Player</b></i></td><td><center><b>Race</b></td><td><center><b>Level</b></td><td><center><b>Free Exp</b></td></tr>";
    for(i=0;i<pname_x.length-1;++i){
    x=i+1;
    if(i==0){
      rankdesc+="<tr><td><center><font color='0099FF' size=5><b><i>"+pname_x[i]+"</i></b></font></td>";
      ...
      rankdesc+="<tr><td><center><font color='00AAEE'>"+x+". <b>"+pname_x[i]+"</b></font></td>";
      rankdesc+="<td><center><b><i>"+rd(race_x[i])+"</i></b></td>";
    ...
    banked_x=banked.split(",");
    race_x=race.split(",");
    rankdesc+="<tr><td><center><i><b>Player</b></i></td><td><center><b>Race</b></td><td><center><b>Stat</b></td></tr>";
    for(i=0;i<pname_x.length-1;++i){
    x=i+1;
    if(i==0){
      rankdesc+="<tr><td><center><font color='00EE00' size=5><b><i>"+pname_x[i]+"</i></b></font></td>";
...
pname="",race="",lvl="",exp="",banked="",quest="",cpower="",cbonus="",cl1="",cl2="",rankmode=0,rankdesc="";
rnamea=new Array("Human","Dwarf","Elf","Dark Elf","Giant","Troll","Goblin","Angel","Gargoyle","Balrog","Kender","Half Elf","Dark Angel","Galatai","Flame Demon");
